...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/CLP_senai_PIC16.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/configuration_bits.c src/interrupts.c src/main.c src/system.c src/user.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/configuration_bits.p1 ${OBJECTDIR}/src/interrupts.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/system.p1 ${OBJECTDIR}/src/user.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/configuration_bits.p1.d ${OBJECTDIR}/src/interrupts.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/system.p1.d ${OBJECTDIR}/src/user.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/configuration_bits.p1 ${OBJECTDIR}/src/interrupts.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/system.p1 ${OBJECTDIR}/src/user.p1

# Source Files
SOURCEFILES=src/configuration_bits.c src/interrupts.c src/main.c src/system.c src/user.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-XC8_PIC16F690.mk dist/${CND_CONF}/${IMAGE_TYPE}/CLP_senai_PIC16.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
